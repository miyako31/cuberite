...
/** Handler for stems from which produce grows in an adjacent block (melon,
pumpkin) after it becomes ripe (meta == 7). ProduceBlockType is the blocktype
for the produce to be grown. StemPickupType is the item type for the pickup
resulting from breaking the stem. */
export template <BlockType ProduceBlockType, Item StemPickupType>
...
export using cBlockMelonStemHandler           = cBlockStemsHandler<BlockType::Melon,   Item::MelonSeeds>;
export using cBlockPumpkinStemHandler         = cBlockStemsHandler<BlockType::Pumpkin, Item::PumpkinSeeds>;
