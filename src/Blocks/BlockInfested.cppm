...
// Declares the cBlockInfestedHandler class representing the handler for
// Silverfish blocks (Mojang calls them Monster Eggs)

#include "BlockHandler.h"
#include "../Entities/Player.h"
export module Block.Infested;





export class cBlockInfestedHandler final:
