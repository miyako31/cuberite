...
// Declares the itemhandlers for throwable items: eggs, snowballs, ender pearls,
// and eyes of ender.
...
export class cItemThrowableHandler:
	public cItemHandler
{
...
export class cItemEggHandler final:
...
export class cItemSnowballHandler final:
	public cItemThrowableHandler
{
	using Super = cItemThrowableHandler;
...
export class cItemEnderPearlHandler final:
	public cItemThrowableHandler
{
	using Super = cItemThrowableHandler;
...
export class cItemBottleOEnchantingHandler final :
	public cItemThrowableHandler
{
	using Super = cItemThrowableHandler;
...
export class cItemFireworkHandler final:
	public cItemThrowableHandler
{
	using Super = cItemThrowableHandler;
